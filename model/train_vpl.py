...
saved_model_path = '../saved_model/VPL_model layers {} n_heads {} d_model {} NSR{} cols {} max_seq_len {} steps {} mode {}.pth'.format( layers,n_heads,d_model,NSR,cols,max_seq_len,steps,mode)
