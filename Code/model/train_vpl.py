...
saved_model_path = '../saved_model/Model VPL_model layers {} n_heads {} d_model {} cols {} max_seq_len {} steps {} mode {}.pth'.format( layers,n_heads,d_model,NSR,cols,max_seq_len,steps,mode)
    
if mode == 3 or mode == 4:
    VRL_path = '../saved_model/Model VRL_model layers {} n_heads {} d_model {} NSR {} cols {} max_seq_len {} lr {} steps {}.pth'.format( layers,n_heads,d_model,NSR,cols,max_seq_len,lr,steps)
